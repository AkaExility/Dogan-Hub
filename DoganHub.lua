...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Dogan Hub Premium Scripts") then
			makefolder("Dogan Hub Premium Scripts")
		end
		if not isfolder("Dogan Hub Premium Scripts/Blox Fruits/") then
			makefolder("Dogan Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("Dogan Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Dogan Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Dogan Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
if QuestC.Visible == true then
						...
						local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/minhhau207/SilverHub/main/uihubS"))()
